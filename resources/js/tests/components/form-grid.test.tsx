...
describe('FormGrid', () => {
  ...
  describe('Width Styling', () => {
    ...
    it('does not apply w_full when fullWidth=false', () => {
      render(
...
it('wendet grid-cols-24 standardmäßig an', () => {
  render(
    <FormGrid>
      <div>Content</div>
    </FormGrid>
...
describe('Title Funktionalität', () => {
  it('zeigt title an wenn vorhanden', () => {
    render(
      <FormGrid title="Form Title">
        <div>Content</div>
      </FormGrid>
  ...
  it('zeigt keinen title an wenn leer', () => {
    render(
      <FormGrid title="">
        <div>Content</div>
      </FormGrid>
    ...
    // Überprüfen, dass kein Title-Container gerendert wird
    const container = screen.getByText('Content').parentElement?.parentElement
    expect(container?.querySelector('.flex.items-center.px-4')).not.toBeInTheDocument()
  })

  it('wendet Standard titleClass an', () => {
    render(
      <FormGrid title="Test Title">
        <div>Content</div>
      </FormGrid>
  ...
  it('wendet custom titleClass an', () => {
    render(
      <FormGrid title="Test Title" titleClass="custom-title-class">
        <div>Content</div>
      </FormGrid>
  ...
  it('rendert action wenn vorhanden', () => {
    render(
      <FormGrid
        title="Form Title"
        action={
...
describe('Grid Configuration', () => {
  it('wendet grid-cols-6 an bei cols={6}', () => {
    render(
      <FormGrid cols={6}>
        <div>Content</div>
      </FormGrid>
  ...
  it('wendet grid-cols-12 an bei cols={12}', () => {
    render(
      <FormGrid cols={12}>
        <div>Content</div>
      </FormGrid>
  ...
  it('wendet grid-cols-24 an bei cols={24}', () => {
    render(
      <FormGrid cols={24}>
        <div>Content</div>
      </FormGrid>
...
describe('Border Styling', () => {
  it('wendet border-styling an wenn border=true', () => {
    render(
      <FormGrid border>
        <div>Content</div>
      </FormGrid>
  ...
  it('wendet keine border-styling an wenn border=false', () => {
    render(
      <FormGrid border={false}>
        <div>Content</div>
      </FormGrid>
...
describe('Grid Layout', () => {
  it('wendet grid-klassen an wenn grid=true', () => {
    render(
      <FormGrid grid>
        <div>Content</div>
      </FormGrid>
  ...
  it('wendet keine grid-klassen an wenn grid=false', () => {
    render(
      <FormGrid grid={false}>
        <div>Content</div>
      </FormGrid>
...
describe('Margin Styling', () => {
  it('wendet margin-klassen an wenn margin=true', () => {
    render(
      <FormGrid margin>
        <div>Content</div>
      </FormGrid>
  ...
  it('wendet keine margin-klassen an wenn margin=false', () => {
    render(
      <FormGrid margin={false}>
        <div>Content</div>
      </FormGrid>
...
describe('Width Styling', () => {
  it('wendet w-full an wenn fullWidth=true', () => {
    render(
      <FormGrid fullWidth>
        <div>Content</div>
      </FormGrid>
  ...
  it('wendet keine w-full an wenn fullWidth=false', () => {
    render(
      <FormGrid fullWidth={false}>
        <div>Content</div>
      </FormGrid>
...
describe('Custom Classes', () => {
  ...
  it('behält basis-klassen bei mit custom className', () => {
    render(
      <FormGrid className="custom-class">
        <div>Content</div>
      </FormGrid>
...
describe('Default Props', () => {
  it('verwendet korrekte default values', () => {
    render(
      <FormGrid>
        <div>Content</div>
      </FormGrid>
...
describe('Struktur', () => {
  ...
  it('rendert mehrere children korrekt', () => {
    render(
      <FormGrid>
        <div data-testid="child-1">Child 1</div>
        <div data-testid="child-2">Child 2</div>
...
describe('Komplexe Kombinationen', () => {
  it('kombiniert alle props korrekt', () => {
    render(
      <FormGrid
        title="Complex Form"
        cols={12}
