...
export const CodeBlockFilename = ({
  ...
  return (
    <div
      className={cn(
        'flex flex-grow items-center gap-2 bg-secondary px-4 py-1.5 text-muted-foreground text-xs',
        className
      )}
      {...props}
    >
...
export const CodeBlockSelect = ({ children, className, ...props }: CodeBlockSelectProps) => {
